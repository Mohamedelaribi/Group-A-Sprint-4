...
<body>
    <a class="mx-auto space-y-4 flex justify-center bg-gray-300 w-40 h-10 text-white mt-2 border rounded p-2 hover:bg-gray-800"  href="/addTutor" >{{ __('messages.addbutton') }}</a>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex flex-col items-center pb-10">
            ...
            <div class="flex mt-4 space-x-3 md:mt-6">
                <a href="EditTutor/{{$tutor->id}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-300 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('messages.editbutton') }}</a>
                <a href="DeleteTutor/{{$tutor->id}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-300 border border-gray-300 rounded-lg hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">{{ __('messages.deletebutton') }}</a>
            </div>
        </div>
    </div>
